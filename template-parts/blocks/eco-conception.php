  ...
  <div class="eco-conception-container">
    ...
    <div class="gauge-container">
      <svg class="gauge" viewBox="0 0 150 150" preserveAscpectRatio="xMinYMin Meet">
        <title id="gaugeTitleEcograder">Ecograder</title>
        <desc id="gaugeDescEcograder">Ceci est une jauge correspondant au pourcentage du Ecograder</desc>
    ...
    <div class="title-green-it">
      ...
      <div class="green-it-note">
        <svg width="74" height="70" viewBox="0 0 74 70" fill="none" xmlns="http://www.w3.org/2000/svg">
          <title id="gaugeTitleGreenIt">GreenIT</title>
          <desc id="gaugeDescGreenIt">Note correspondant au taux écologique du site</desc>
          <rect width="74" height="70" rx="35" fill="var(--color-secondary)"/>

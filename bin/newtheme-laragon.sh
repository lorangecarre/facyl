#!/bin/bash
# WordPress theme starting bash script for facyl (Laragon version)
...
# Get latest facyl version with updates and copy it over to your project
...
# Create latest facyl development packages for project root level (gulp paths etc.)
source ${SCRIPTS_LOCATION}/tasks/project.sh

# Clean up leftover development files from facyl
source ${SCRIPTS_LOCATION}/tasks/cleanups.sh

# Replace facyl with your theme name and other seds (WSL version)

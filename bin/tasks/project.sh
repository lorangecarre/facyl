...
sed -e "s/\facyl/${THEME_NAME}/" -e "s/\facyl/${THEME_NAME}/" -e "s/\facyl/${THEME_NAME}/" ${PROJECT_PATH}/devpackages/.stylelintrc > ${PROJECT_PATH}/devpackages/.stylelintrc2
cp ${PROJECT_PATH}/devpackages/.stylelintrc2 ${PROJECT_PATH}/.stylelintrc
sed -e "s/\facyl/${THEME_NAME}/" -e "s/\facyl/${THEME_NAME}/" -e "s/\facyl/${THEME_NAME}/" ${PROJECT_PATH}/devpackages/.eslintrc.js > ${PROJECT_PATH}/devpackages/.eslintrc2.js
...
sed -e "s/\facyl/${THEME_NAME}/" -e "s/\facyl/${THEME_NAME}/" -e "s/\facyl/${THEME_NAME}/" ${PROJECT_PATH}/devpackages/gulp/config.js > ${PROJECT_PATH}/gulp/config2.js
rm ${PROJECT_PATH}/gulp/config.js
sed -e "s/\facyl/${PROJECT_NAME}/" -e "s/\facyl/${PROJECT_NAME}/" -e "s/\facyl/${PROJECT_NAME}/" ${PROJECT_PATH}/gulp/config2.js > ${PROJECT_PATH}/gulp/config.js
